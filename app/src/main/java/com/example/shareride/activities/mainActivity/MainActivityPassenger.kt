...
import com.example.shareride.activities.mainActivity.fragments.historyActivity
...
class MainActivityPassenger : AppCompatActivity() {
    ...
    private lateinit var switchRole: SwitchCompat
    ...
    private var activityFragment: historyActivity? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        pageName.text = viewModel.page_name
        ...
        binding.bottomNavView.setOnItemSelectedListener {
            when (it.itemId) {
                ...
                R.id.activity_it -> {
                    replaceFragment(getActivityFragment())
                    pageName.text = viewModel.page_name
                    viewModel.clicks_bf_createride("Activity")
                }
    ...
    private fun getActivityFragment(): Fragment {
        if (activityFragment == null) {
            activityFragment = historyActivity()
        }
